  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        String sql =
          "INSERT INTO Trajet (villeDepart, villeDestination, adresseDepart, adresseDestination, dateDepart, dateArrivee, vehicule, immatriculation, nbPlacesLibres, conducteur_id, tarif, commentaire) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
