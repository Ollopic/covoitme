...
@WebServlet(name = "ServletListRequest", urlPatterns = { "/listrequest" })
public class ServletListRequest extends HttpServlet {

  private static final Logger logger = Logger.getLogger(ServletListRequest.class.getName());
